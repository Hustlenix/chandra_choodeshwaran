...
export default function VoicesOfChange() {
  return (
    <section id="voices" className="relative overflow-hidden bg-navy-900 py-section-lg">
      {/* Background radial glow */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute bottom-0 right-0 h-[500px] w-[500px] translate-x-1/3 translate-y-1/3 rounded-full bg-gold-500/[0.03] blur-[120px]" />
        <div className="absolute left-0 top-1/3 h-[400px] w-[400px] -translate-x-1/3 rounded-full bg-tertiary-indigo/[0.02] blur-[100px]" />
      </div>
